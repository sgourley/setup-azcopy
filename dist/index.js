...
var require_tool_cache = __commonJS({
  "node_modules/@actions/tool-cache/lib/tool-cache.js"(exports) {
    ...
    function extractXar(file, dest, flags = []) {
      return __awaiter(this, void 0, void 0, function* () {
        assert_1.ok(IS_MAC2, "extractXar() not supported on current OS");
        assert_1.ok(file, 'parameter "file" is required');
        dest = yield _createExtractFolder(dest);
        let args;
        if (flags instanceof Array) {
...
async function main() {
  try {
    const sourceUrl = IS_WINDOWS ? "https://aka.ms/downloadazcopy-v10-windows" : IS_MAC ? "https://aka.ms/downloadazcopy-v10-mac" : "https://aka.ms/downloadazcopy-v10-linux";
